...
with st.container():
    text_column, image_column = st.columns((5, 3))
    with text_column:
        ...
        st.markdown(
            """
            <p style="font-size: 22px;"><b>The following work was accomplished during my postdoctoral research:</b></p>
            <ul>
        ...
        st.markdown(
            ...
            <ul>
                <li style="font-size: 20px;"> 1. Yujia Zhang and Guang Li. Robust tube-based model predictive control for wave energy converters. IEEE Transactions on Sustainable Energy (2022). </li>
                <li style="font-size: 20px;"> 2. Yujia Zhang, Hongbiao Zhao, Guang Li, Christopher Edwards, and Mike Belmont. Robust nonlinear model predictive control of an autonomous launch and recovery system. IEEE Transactions on Control Systems Technology (2023). </li>
                <li style="font-size: 20px;"> 3. Yujia Zhang, Guang Li and Mustafa Al-Ani. Robust Learning-based Model Predictive Control for Wave Energy Converters. IEEE Transactions on Sustainable Energy (2024). </li>
                <li style="font-size: 20px;"> 4. Yujia Zhang and Guang Li. Towards Robust and High-performance Operations of Wave Energy Converters: an Adaptive Tube-based Model Predictive Control Approach. IFAC-PapersOnLine, 55(31):339-344, 2022. </li>
            </ul>
            """, 
            unsafe_allow_html=True
        )
...
with st.container():
    ...
    with text_column:
        ...
        st.markdown(
            ...
            <ul>
                <p style="font-size: 20px;"><b>-&nbsp;&nbsp;Postdoctoral research:</p>
